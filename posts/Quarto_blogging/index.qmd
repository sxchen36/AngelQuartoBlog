...
As a side note, I am doing this blogging setup on my M1 Mac with VSCode as my Editor. I am also uploading my blog's source code to my [Git repository](https://sxchen36.github.io/AngelQuartoBlog/?)
...
* Call `quarto publish gh-pages` inside your project in terminal to publish your first blog!
* Note that above command does NOT check in your code. Do your diligent to git commit & git push to your git repository to save your source code
